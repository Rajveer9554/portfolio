      ...
      >
        ...
        <ul className="space-y-5 text-lg leading-relaxed">
          {[
            ...
            "I have a strong focus on user experience and clean UI design, ensuring every website I build feels smooth and professional.",
            "On the backend, I possess around 40% working knowledge of Node.js and Express.js.",
            "I also have experience working with databases like MongoDB, enabling full-stack applications.",
            "I enjoy transforming creative ideas into real-world digital experiences.",
            "My goal is to become a Full Stack Developer blending technical precision with creativity.",
            "I aim to continuously learn, solve real-world problems, and collaborate with tech communities.",
          ].map((text, index) => (
            <motion.li
              key={index}
